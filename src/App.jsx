...
const App = () => {
    ...
    const renderPage = () => {
        switch (currentPage) {
            case 'productos':
                return <CategoryPage title="Productos" category="productos" onAddToCart={addToCart} />;
            case 'exclusivos':
                return <CategoryPage title="Exclusivos" category="exclusivos" onAddToCart={addToCart} />;
            case 'cart':
                return (
                    <CartPage 
                        cart={cart}
