        ...
        <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
                ...
                <div className="md:col-span-1 mb-6 md:mb-0">
                    <h3 className="font-black text-2xl text-white tracking-wider mb-4">Solcito de pan</h3>
                    <p className="text-sm">Pancita llena corazón contento.</p>
                </div>
                {/* Columnas de enlaces */}
                <div>
                ...
                <div>
                 ...
                 <div>
                    ...
                    <p className="mb-2">Email: contacto@solcitodepan.com</p>
                    <p className="mb-2">Tel: (+57) 300 123 4567</p>
            ...
            <div className="mt-8 py-4 border-t border-yellow-200 text-center text-sm">
                <p>&copy; {new Date().getFullYear()} Solcito de Pan. Todos los derechos reservados.</p>
